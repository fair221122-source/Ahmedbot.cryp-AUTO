...
SYMBOLS = os.getenv(
    SYMBOLS=BTCUSDT,ETHUSDT,BNBUSDT,ADAUSDT,XRPUSDT,SOLUSDT,MATICUSDT,DOGEUSDT
,LTCUSDT,OPUSDT,ARBUSDT,AVAXUSDT,DOTUSDT,ATOMUSDT,LINKUSDT,TRXUSDT
,APTUSDT,NEARUSDT,FILUSDT,SUIUSDT,INJUSDT,SEIUSDT,PEPEUSDT,ORDIUSDT
,TAOUSDT,ENAUSDT,FTMUSDT,HBARUSDT,ARUSDT,MKRUSDT
).split(",")
